...
**social distancing** sub-model and the **integrated** structure (synthesis).
...
Here, we verify that the synthesis model and intervention-specific models 
produce identical output under equivalent configurations.
...
```{r, fig.cap = "Fig 1. Output comparison", warning = FALSE}
...
plot(c_df, pch = 16, cex = 0.5, col = "steelblue",
...
demo_df <- sd_sensitivity_run(mdl_sens$deSolve_components, 
                   consts_df = data.frame(par_xi = c(0.7, 0), par_tau_m = 35),
                   start_time = 0, stop_time = 600, timestep = 1 /32, 
...
g <- plot_fig_09(sens_mob, c_star_df, demo_df, sim_output_b)
